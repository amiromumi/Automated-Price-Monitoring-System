...
پیش از استفاده از این اسکریپت‌ها، به توکن بات تلگرام و Chat ID نیاز دارید. راهنمای گام‌به‌گام را در [راهنمای راه‌اندازی بات تلگرام](../../docs/telegram-bot-setup-fa.md) ببینید.
